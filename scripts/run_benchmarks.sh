#!/usr/bin/env bash
#
# Run trnsparse benchmarks on the trnsparse CI instance and pull results back.
#
# Usage:
...
CMD_ID=$(aws ssm send-command \
  ...
  --comment "trnsparse benchmarks @ $SHA" \
