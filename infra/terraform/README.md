# Terraform — trnsparse Neuron CI Instance
...
user-data to finish (installs Neuron SDK, clones trnsparse), then stop it:
...
| `instance_tag` | `trnsparse-ci-trn1` | Must match `scripts/run_neuron_tests.sh [type]` arg |
| `vpc_id` | (required) | |
